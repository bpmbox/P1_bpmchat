function myFunction12_06_01() {
  ...
  console.log(text.getText()); //テキストオブジェクト
  ...
  console.log(text.getFontFamily()); //Meiryo
  ...
  console.log(text.getLinkUrl()); //http://tonari-it.com/
...
function myFunction12_06_02() {
  ...
  paragraphs[3].editAsText().setLinkUrl('https://tonari-it.com');
}