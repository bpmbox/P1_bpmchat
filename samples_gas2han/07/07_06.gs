function myFunction07_06_01() {
  ...
  console.log(new Date(2020, 7, 17, 10, 28, 15)); //Mon Aug 17 2020 10:28:15 GMT+0900 (日本標準時)
  console.log(new Date('2020/07/17 10:28:15')); //Fri Jul 17 2020 10:28:15 GMT+0900 (日本標準時)
  console.log(new Date(1594949295777)); //Fri Jul 17 2020 10:28:15 GMT+0900 (日本標準時)
  
  const d = new Date();
  console.log(new Date(d)); //実行時の日時
}
...
function myFunction07_06_02() {
  ...
  console.log(d.getMonth()); //6(=7月)
  console.log(d.getDate()); //17
  console.log(d.getDay()); //5(=金曜日)
  ...
  console.log(d.toString()); //Wed Jan 01 2020 01:11:11 GMT+0900 (日本標準時)
  console.log(d.toDateString()); //Wed Jan 01 2020
  console.log(d.toTimeString()); //01:11:11 GMT+0900 (日本標準時)
...
function myFunction07_06_03() {
  ...
  console.log(start); //Tue May 05 2020 20:00:00 GMT+0900 (日本標準時)
  console.log(end); //Tue May 05 2020 22:00:00 GMT+0900 (日本標準時)
}
